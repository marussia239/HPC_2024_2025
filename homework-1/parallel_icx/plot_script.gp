...
plot datafile using 1:2 title '1 thread' with linespoints, \
     '' using 1:3 title '2 threads' with linespoints, \
     '' using 1:4 title '5 threads' with linespoints, \
     '' using 1:5 title '10 threads' with linespoints, \
     '' using 1:6 title '20 threads' with linespoints, \
     '' using 1:7 title '40 threads' with linespoints, \
     '' using 1:8 title '60 threads' with linespoints, \
     '' using 1:9 title '100 threads' with linespoints
